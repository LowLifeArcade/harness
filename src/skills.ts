...
export const SKILL_NAMES = ['cloudflare', 'wrangler', 'workers-best-practices', 'agents-sdk'] as const;
...
export async function loadSkill(name: SkillName): Promise<string> {
    ...
    const candidates = [join(codexHome, 'skills', skillDirectories[name], 'SKILL.md'), join(import.meta.dir, '..', 'skills', `${name}.md`)];
